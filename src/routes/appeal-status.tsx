      ...
      <div className="page-container max-w-3xl py-10 md:py-14">
          ...
          <CardContent className="p-5 md:p-6">
            <form className="flex flex-col gap-3 sm:flex-row sm:items-end" onSubmit={(e) => e.preventDefault()}>
              <div className="flex-1 space-y-1.5">
                ...
                <Input id="appeal-no" placeholder="DOPST/A/2026/0000411" className="font-mono" />
              </div>
              <Button type="submit">
        ...
        <div className="mt-8">
          <EmptyState
            ...
            description="Appeal lookup will read from the case database once it is connected."
            icon={Gavel}
          />
        </div>
      </div>
