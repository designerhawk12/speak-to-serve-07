...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      feedback: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "feedback_evidence_document_id_fkey";
      ...
      officer_assignment_profiles: {
        Row: {
          created_at: string;
          is_active: boolean;
          jurisdiction_district_names: string[];
          jurisdiction_location_terms: string[];
          jurisdiction_state_names: string[];
        ...
        Relationships: [
          {
            foreignKeyName: "officer_assignment_profiles_officer_id_fkey";
            columns: ["officer_id"];
            isOneToOne: true;
            referencedRelation: "profiles";
            referencedColumns: ["id"];
    ...
    Views: {
      officer_case_queue: {
        Row: {
          administrative_state: Database["public"]["Enums"]["administrative_state"] | null;
          appellate_organization_id: string | null;
          assigned_officer_id: string | null;
          category_id: string | null;
          category_name: string | null;
          citizen_confirmation_state:
            Database["public"]["Enums"]["citizen_confirmation_state"] | null;
          citizen_id: string | null;
          closed_at: string | null;
          created_at: string | null;
          disposed_at: string | null;
          district_name: string | null;
          has_appeal_attention: boolean | null;
          id: string | null;
          last_meaningful_government_action_at: string | null;
          location_text: string | null;
          organization_id: string | null;
          ...
          outcome_state: Database["public"]["Enums"]["outcome_state"] | null;
          ...
          waiting_on_citizen: boolean | null;
        };
        Relationships: [
          {
            foreignKeyName: "grievances_appellate_organization_id_fkey";
    ...
    Functions: {
      appellate_record_appeal_decision: {
        Args: {
          p_appeal_id: string;
          p_decision_reasons: string;
          p_decision_summary: string;
        };
        Returns: undefined;
      };
      appellate_request_office_reply: {
        Args: { p_appeal_id: string; p_instructions: string };
        Returns: string;
      };
      citizen_confirm_resolution: {
        Args: {
          p_confirmation: Database["public"]["Enums"]["citizen_confirmation_state"];
          p_evidence_document_id: string;
          p_grievance_id: string;
          p_requested_correction: string;
          p_what_remains_unresolved: string;
          p_what_was_fixed: string;
        };
        Returns: undefined;
      };
      citizen_create_appeal: {
        Args: {
          p_grievance_id: string;
          p_grounds: string;
          p_requested_relief: string;
        };
        Returns: string;
      };
      ...
      officer_reply_to_appeal: {
        Args: { p_appeal_id: string; p_reply: string };
        Returns: string;
      };
      officer_request_clarification: {
        Args: { p_grievance_id: string; p_instructions: string };
        Returns: undefined;
      };
      officer_request_documents: {
        Args: {
          p_due_at: string;
          p_grievance_id: string;
      ...
      officer_submit_resolution: {
        Args: {
          ...
          p_citizen_next_step: string;
          p_evidence_reference: string;
          p_grievance_id: string;
          p_outcome_achieved: string;
          p_partial_or_unresolved_reason: string;
          p_resolution_narrative: string;
        };
        Returns: string;
      };
      officer_transfer_grievance: {
        Args: {
          p_grievance_id: string;
    ...
    Enums: {
      ...
      appeal_state: "FILED" | "UNDER_REVIEW" | "DECIDED" | "REJECTED" | "WITHDRAWN";
      citizen_confirmation_state:
        | "NOT_REQUESTED"
